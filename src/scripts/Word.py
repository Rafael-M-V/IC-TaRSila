...
class Word:
	...
	def __init__(self, word, pos, rel_path, gramatica=None):
		...
		if(Word.homographs == None):
			Word.homographs = ExceptionHashMap(os.path.join(rel_path, "Dictionaries/Homographs.json"))
			Word.homographs.create_hash()
		if(Word.verbs == None):
			Word.verbs = ExceptionHashMap(os.path.join(rel_path, "Dictionaries/Verbs.json"))
			Word.verbs.create_hash()
		if(Word.exceptions == None):
			Word.exceptions = ExceptionHashMap(os.path.join(rel_path, "Dictionaries/Exceptions.json"))
	...
	@staticmethod
	def update_exceptions(rel_path):
		base_dir='.'
		Word.homographs = ExceptionHashMap(os.path.join(rel_path, "Dictionaries/Homographs.json"))
		Word.homographs.create_hash()
		print(os.path.join(rel_path, "Dictionaries/Verbs.json"))
		Word.verbs = ExceptionHashMap(os.path.join(rel_path, "Dictionaries/Verbs.json"))
		Word.verbs.create_hash()
		print(os.path.join(rel_path, "Dictionaries/Exceptions.json"))
		Word.exceptions = ExceptionHashMap(os.path.join(rel_path,"Dictionaries/Exceptions.json"))
		Word.exceptions.create_hash()
